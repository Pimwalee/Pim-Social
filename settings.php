...
<div class="main_column column">
    ...
    <p style="font-weight:bold;">Modify the values and click 'Update Details'</p>

    <?php
    $user_data_query = $con->query("SELECT first_name, last_name, email FROM users WHERE username='$userLoggedIn'");
    $row = $user_data_query->fetch(PDO::FETCH_BOTH);
    ...
    </form><!--$user is array user data from header.php-->
    ...
    <input type="submit" name="update_password" id="save_details" value="Update Password" class="default settings_submit"><br>
    </form>
