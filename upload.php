...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/pimsocial/assets/images/profile_pics';
	//Set File name	
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		$insert_pic_query = $con->query("UPDATE users SET profile_pic='$result_path' WHERE username='$userLoggedIn'");
